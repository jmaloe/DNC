				 ...
				 <div class="panel-body">
				 	...
				 	<div class="form-group">
					 	...
					 	<div class="form-group">
					 		...
					 		echo '<a href="../formularios/FActividad.php" class="btn btn-default">Página principal</a>';
					 		?>
					 	</div>
				 		</fieldset>
				 	</div>
				 		...
				 		?>				 			
					 		<fieldset>
					 			...
					 			<div class="doce form-group">
					 				...
					 				<div class="cinco">
					 					<input type="submit" name="accion" value="Asignar" class="btn btn-primary separador">				 					
					 				</div>
					 			</div>
					 		</fieldset>
				 		<?php
				 			...
				 			<div class="doce form-group">
				 				...
				 				<div class="cuatro separador">
				 					<select name="roles_asignados" class="form-control">
				 						<?php
				 						$permiso->setIdUsuario($usuario->getIdUsuario());
				 							echo $permiso->getRolesByUser(isset($_POST['roles_asignados'])?$_POST['roles_asignados']:0);
				 						?>
				 					</select>
				 				</div>
				 				<div class="cinco">
				 					<input type="submit" name="accion" value="Mostrar" class="btn btn-primary separador">
				 					<?php
				 						if($acceso['d'])
				 							echo '<input type="submit" name="accion" value="Eliminar" class="btn btn-danger">';
				 					?>
				 				</div>
				 			</div>
				 			<?php
